                    ...
                    <div className="row align-items-center">
                        <div className="col-xl-7 col-lg-6 order-0 order-lg-2">
                            <div className="about-img-wrap ">
                                <img  src="/assets/img/resCleaning.jpg" alt="" className="wow fadeInRight fam" data-wow-delay=".4s" />
                            ...
                            <div className="about-content">
                                ...
                                <div className="about-list">
                                    <ul className="list-wrap">
                                        <li><i className="fas fa-check" />Offers expert pressure washing and painting services to residential and commercial properties.</li>
                                        <li><i className="fas fa-check" />Removes tough stains and rejuvenates properties using top-quality equipment..</li>
                                        <li><i className="fas fa-check" />Provides free estimates and transparent service with a focus on quality and customer satisfaction.</li>
                                    </ul>
                                </div>
