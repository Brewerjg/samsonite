                    ...
                    <div className="row">
                        <div className="col-xl-3 col-md-6">
                            <div className="work-item">
                                ...
                                <div className="work-content">
                                    <h2 className="title">Get a Fast Quote</h2>
                        ...
                        <div className="col-xl-3 col-md-6">
                            <div className="work-item">
                                ...
                                <div className="work-content">
                                    <h2 className="title">Select a Package</h2>
                                    <p>Suffered alteration in some a form, by injected humour, or randomised word</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-3 col-md-6">
                            <div className="work-item">
                                ...
                                <div className="work-content">
                                    <h2 className="title">Expert Cleaning</h2>
                                    <p>Suffered alteration in some a form, by injected humour, or randomised word</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-3 col-md-6">
                            <div className="work-item">
                                ...
                                <div className="work-content">
                                    <h2 className="title">Enjoy the Results</h2>
                                    <p>After we’re done you'll be the envy of the neighborhood.</p>
                                </div>
                            </div>
                        </div>
                    </div>
